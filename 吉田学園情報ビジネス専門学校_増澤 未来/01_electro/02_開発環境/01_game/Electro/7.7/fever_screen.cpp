////////////////////////////////////////////////////
//
//    FeverScreenの処理[fever_screen.cpp]
//    Author:増澤 未来
//
////////////////////////////////////////////////////
...
// マクロ定義
//**********************************
#define TEXTURE_PATH "./data/Textures/fever_screen2.png" // テクスチャのパス
#define ANIM_SPEED 3           // アニメーション速度
#define MAX_ANIMATION_X 11     // アニメーション数 横
#define MAX_ANIMATION_Y 1      // アニメーション数 縦
#define COLOR_COUNT 20         // 目標カラー変更のインターバル
#define COLOR_RATE  0.05f      // 色を変えるとき係数
#define LOGO_SIZE D3DXVECTOR3(SCREEN_WIDTH/2, SCREEN_HEIGHT/2, 0.0f)   // サイズ画像の解像度に合わせる
#define LOGO_POS  D3DXVECTOR3(SCREEN_WIDTH/2,SCREEN_HEIGHT/2,0.0f)     // 座標

//**********************************
// 静的メンバ変数宣言
//**********************************
LPDIRECT3DTEXTURE9 CFeverScreen::m_pTexture = NULL;

//=============================
// コンストラクタ
//=============================
CFeverScreen::CFeverScreen() :CScene2d(OBJTYPE_UI)
{
	// 変数のクリア
...
// クリエイト
//=============================
CFeverScreen * CFeverScreen::Create(void)
{
	// メモリの確保
	CFeverScreen *pFeverScreen = new CFeverScreen;
	// 初期化
	pFeverScreen->Init();
	return pFeverScreen;
}
...
// テクスチャのロード
//==================================
HRESULT CFeverScreen::Load(void)
{
...
// 初期化処理
//=============================
HRESULT CFeverScreen::Init(void)
{
	CScene2d::Init();
	...
	//SetAddMode(true);
	// ランダムで初期化
	m_distColor = D3DXCOLOR(1.0f, 1.0f, ((float)(rand() % 50) / 100.0f) + 0.5f, 1.0f);
	return S_OK;
}
...
void CFeverScreen::Update(void)
{
	...
	{
		m_distColor = D3DXCOLOR(1.0f, 1.0f, ((float)(rand() % 50) / 100.0f) + 0.5f, 1.0f);// 目標カラーの変更
	}
	else
	{
		// 現在カラーの取得
