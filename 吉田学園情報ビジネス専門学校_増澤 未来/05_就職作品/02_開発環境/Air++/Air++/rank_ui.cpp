...
#define SIZE D3DXVECTOR3( 80.0f, 80.0f, 0.0f)   // サイズ*画像の解像度に合わせる

// 位置
#define POS_PLAYER1_1 D3DXVECTOR3( SCREEN_WIDTH    - 90 ,  SCREEN_HEIGHT    - 80 , 0.0f)  // 画面分割してないとき
#define POS_PLAYER1_2 D3DXVECTOR3( SCREEN_WIDTH    - 90 , (SCREEN_HEIGHT/2) - 80 , 0.0f)  // 画面を二つに分けているときのプレイヤー1
#define POS_PLAYER1_4 D3DXVECTOR3((SCREEN_WIDTH/2) - 90 , (SCREEN_HEIGHT/2) - 60 , 0.0f)  // 画面を四つに分けているときのプレイヤー1
#define POS_PLAYER2_2 D3DXVECTOR3( SCREEN_WIDTH    - 90 ,  SCREEN_HEIGHT    - 80 , 0.0f)  // 画面を二つに分けているときのプレイヤー2
#define POS_PLAYER2_4 D3DXVECTOR3( SCREEN_WIDTH    - 90 , (SCREEN_HEIGHT/2) - 60 , 0.0f)  // 画面を四つに分けているときのプレイヤー2
#define POS_PLAYER3   D3DXVECTOR3((SCREEN_WIDTH/2) - 90 , (SCREEN_HEIGHT)   - 60 , 0.0f)  // プレイヤー3
#define POS_PLAYER4   D3DXVECTOR3( SCREEN_WIDTH    - 90 , (SCREEN_HEIGHT)   - 60 , 0.0f)  // プレイヤー4
