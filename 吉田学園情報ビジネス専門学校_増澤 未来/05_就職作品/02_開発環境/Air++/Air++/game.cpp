...
// 静的メンバ変数宣言
//=============================
CCamera *CGame::m_pCamera = NULL;                          // カメラクラスポインタ
...
HRESULT CGame::Init(void)
{
	...
	// CPU生成
	m_apCharacter[m_nNumCaracter] = CCpu::Create(D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, D3DXToRadian(180.0f), 0.0f), CCpu::CPU_TYPE_STAR , 1);
	// キャラクター数加算
	m_nNumCaracter++;
	
	// CPU生成
	m_apCharacter[m_nNumCaracter] = CCpu::Create(D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, D3DXToRadian(180.0f), 0.0f), CCpu::CPU_TYPE_RUIN, 2);
	// キャラクター数加算
	m_nNumCaracter++;
